...
import subprocess
import time
from mqtt_logger import mqtt_args, load_messages, MQTTLogger
...
def fuzzer(valid_input, n_cases=10):
    ...
    import os
    import shutil
    fuzz_case_dir = tempfile.mkdtemp()
    valid_case_file = 'infosec_input.txt'
